...
const NavBar = ({openAreYouSureModal, openNewPlayerModal}) => {
    ...
    return (
        <div className="grid grid-cols-3 gap-1 px-2">
			...
			<button
				className="red-btn round-btn h-10 flex justify-center items-center text-white cursor-pointer transition-colors"
			...
			<button 
                className="round-btn green-btn btn h-10 flex justify-center items-center text-white cursor-pointer transition-colors"
				onClick={() => openAreYouSureModal(event, resetBtnRef, newBtnRef)}
				ref={newBtnRef}
			>
				<span>New</span>
